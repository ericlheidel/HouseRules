    ...
    public partial class Seed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChoreAssignment_UserProfile_UserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChoreCompletion_UserProfile_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 1, 1, "Wash Dishes" },
                    { 2, 7, 2, "Vacuum Living Room" },
                    { 3, 2, 1, "Take Out Trash" },
                    { 4, 14, 3, "Clean Bathroom" },
                    { 5, 7, 4, "Mow Lawn" },
                    { 6, 3, 2, "Do Laundry" },
                    { 7, 1, 2, "Cook Dinner" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "101 Main Street", "charlie@kelly.com", "Charlie", "dbc40bc6-0829-4ac5-a3ed-180f5e916a5f", "Kelly", "Charlie" },
                    { 2, "222 Broadway Ave.", "frank@reynolds.com", "Frank", "frt98wr5-0223-3ww7-t6rq-028g4r521d4e", "Reynolds", "Frank" },
                    { 3, "333 Broadway Ave.", "mac@mcdonald.com", "Mac", "hdp65oa9-3053-5ap0-z0hh-235t2a098h8q", "McDonald", "Mac" }
                });
